...
angular.module('ioAtSpotApp')
    .controller('WorkedHoursCtrl',
        function ($scope, socket, WorkedHours, $moment, $modal, authModel, Members, messageCenterService) {
...
/*                //Chart
            ...
            $scope.utils = new function () {
                ...
                utils.getMember = function(uid){
                  for(var i=0; i< $scope.model.members.length; i++){
                    if($scope.model.members[i]._user._id == uid) return $scope.model.members[i];
                  }
                };
                ...
                utils.filterLess = function( ) {
                  return function(item) {
                    if($scope.model.onlyLess){
                      return utils.hasWarning(item);
                    }else {
                      return true;
                    }
                  };
