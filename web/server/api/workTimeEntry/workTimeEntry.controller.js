...
exports.update = function (req, res, next) {
  WorkTimeEntry.findById(req.params.id, function (err, workTimeEntry) {
    ...
    var orig_performedAt = workTimeEntry.performedAt;
    var orig_workTimeEntryType = workTimeEntry.workTimeEntryType;
...
function sendNotificationMail(html, callback) {

  var mailOptions = {
    subject: 'io@spot - Changed worktimeentry',
    html: html
  };
